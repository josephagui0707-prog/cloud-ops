  ...
  return <Page>
    <motion.div variants={staggerContainer} initial="hidden" animate="show">
      ...
      <motion.div className="stats-grid" variants={staggerContainer}>
        ...
        <Card hoverable className="stat-card premium"><div className="stat-top"><span className="stat-icon green"><ShieldCheck size={20}/></span><span className="security-status">5 controles</span></div><span className="stat-label">Postura de seguridad</span><strong className="security-value">Saludable</strong><small className="success-text">● 4 correctos · 1 revisión</small></Card>
      </motion.div>
